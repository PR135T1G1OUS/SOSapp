...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const isInstitutionResponder = responderDoc.exists();

      if (isResponder || isInstitutionResponder) {
        Alert.alert('Welcome Responder!', "You've successfully logged in.", [
          {
            text: 'Continue',
    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          >
            <Text style={styles.registerText}>
              Register as a Responder Institution
            </Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  title: { textAlign: 'center', marginBottom: 10, color: '#d32f2f' },
  ...
  registerText: { color: '#2196f3', fontSize: 16 },
  versionContainer: { marginTop: 30, alignItems: 'center' },
  version: { color: '#999', fontSize: 12 },
});